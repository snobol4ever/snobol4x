...
RUNG_DIR="${CORPUS_REPO:-$(cd "$SCRIPT_DIR/../../.." && pwd)/corpus}/programs/icon/rung30_builtins_misc"
for icn in "$RUNG_DIR"/t*.icn; do
  ...
  timeout 30 java -jar src/backend/jvm/jasmin.jar /tmp/t30.j -d /tmp/ 2>/dev/null
