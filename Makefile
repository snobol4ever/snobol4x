...
scrip:
	...
	$(CC) $(CBASE) -I$(SRC)/frontend/snobol4 -c $(SRC)/frontend/prolog/prolog_interp.c   -o $(OBJ)/prolog_interp.o
	...
	$(CC) $(CBASE) -I$(SRC)/frontend/snobol4 -c $(SRC)/frontend/icon/icon_interp.c      -o $(OBJ)/icon_interp.o
